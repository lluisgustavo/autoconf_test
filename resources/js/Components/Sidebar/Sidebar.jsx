...
import SmallApplicationLogo from "../SmallApplicationLogo";
...
export const SidebarLink = ({
    ...
    const activeClasses =
        "text-white bg-autoconf-blue shadow-lg hover:bg-autoconf-blue";
