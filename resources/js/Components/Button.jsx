...
export default ({
    ...
    switch (variant) {
        case "secondary":
            variantClasses = `bg-white text-gray-500 hover:bg-gray-100 focus:ring-autoconf-blue dark:text-gray-400 dark:bg-dark-eval-1 dark:hover:bg-dark-eval-2 dark:hover:text-gray-200`;
            break;
        case "success":
        ...
        case "black":
            ...
            break;
        default:
            variantClasses = `bg-autoconf-blue text-white hover:bg-autoconf-blue focus:ring-autoconf-blue`;
    }
