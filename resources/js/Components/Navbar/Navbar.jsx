                ...
                <div className="flex items-center gap-2">
                    ...
                    <Dropdown
                        trigger={
                            <Button
                                type="button"
                                className="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out bg-autoconf-blue border border-transparent rounded-md hover:text-gray-300 focus:outline-none focus:ring focus:ring-autoconf-blue focus:ring-offset-1 focus:ring-offset-white dark:focus:ring-offset-dark-eval-1 dark:bg-dark-eval-1 dark:text-gray-400 dark:hover:text-gray-200"
                            >
                                {auth.user.name}
